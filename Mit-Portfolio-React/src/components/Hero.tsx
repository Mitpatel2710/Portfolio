...
import { ArrowRight, Code2, Brain, Timer, FileText } from 'lucide-react';
        ...
        >
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold">
              ...
              >
                Code that works in development is cool but,
              </motion.span>
            </h1>
            ...
            <motion.p
              ...
              whileHover={{ scale: 1.02 }}
            >
              The code that works in production is legendary.
            </motion.p>
          </motion.div>
